// motion_logger.cpp - Allan Variance용 raw IMU 데이터 수집
//
// 빌드: g++ -O2 -std=c++17 -o motion_logger motion_logger.cpp
// 실행: ./motion_logger 300 imu_motion.csv     # 300초 = 5분
//
// 출력 CSV 형식:
...
int main(int argc, char** argv) {
    ...
    // 5분 움직임 측정
    fprintf(stderr, "[READY] Starting in 5 seconds. Get ready!\n");
